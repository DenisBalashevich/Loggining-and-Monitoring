...
namespace MvcMusicStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(CounterHelper<Counters> counterHelper, UserManager<ApplicationUser> userManager)
        {
            _counterHelper = counterHelper;
            _userManager = userManager;
        }

        public AccountController(CounterHelper<Counters> counterHelper)
            : this(counterHelper,
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    _counterHelper.Increment(Counters.SuccessLogInsCounter);
        ...
        public ActionResult LogOff()
        {
            ...
            _counterHelper.Increment(Counters.SuccessLogOffsCounter);
